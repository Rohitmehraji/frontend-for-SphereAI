...
import { getCustomerSupportResponse } from '../../../services/aiToolsService';
...
export default function CustomerSupportTool() {
  ...
  const handleGenerate = async () => {
    setLoading(true);
    try {
      const res = await getCustomerSupportResponse({ prompt: input });
      setOutput(res.result || "AI support response generated!");
